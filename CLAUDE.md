...
```
---
📊 사용된 Skills: (없음) 또는 skill1, skill2
🤖 사용된 Subagents: (없음) 또는 agent1, agent2
```

- Skills: `.claude/skills/` 폴더의 skill을 호출한 경우 표시
...
7. ✅ **아키텍처 리뷰** → `architect-reviewer`
   ```
   예: "Docker 환경 구조를 리뷰해줘", "전체 시스템 아키텍처 검토"
   ```
